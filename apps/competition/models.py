...
from apps.media.models import Audio, Genre, Image, Video
...
class Competition(models.Model):
    ...
    competition_page_image = models.ImageField(blank=True, null=True, upload_to="%y/%m/%d",
                                               verbose_name="Competition Image")
...
class CompetitionEntryRating(models.Model):
    """Competition entry comment"""
    competition_entry = models.ForeignKey('competition.CompetitionEntry')
