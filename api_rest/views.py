...
from competition.models import Competition, CompetitionChart, CompetitionEntryAudio, CompetitionEntryRating, CompetitionJudge,\
                               CompetitionEntry
from .serializers import AudioCommentSerializer, AudioLikeSerializer, AudioPlaylistSerializer, PlaylistItemSerializer, UserProfileSerializer,\
                         ...
                         CompetitionSerializer, CompetitionChartSerializer, CompetitionEntryRatingSerializer,\
                         AudioSerializer, VideoSerializer
