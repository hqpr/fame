...
from competition.models import Competition, CompetitionChart, CompetitionGenre,\
                               CompetitionCountry, CompetitionEntryAudio, CompetitionEntryVideo,\
                               CompetitionEntryRating, CompetitionStage
from media.models import Audio, AudioLike, AudioComment, AudioPlaylist, PlaylistItem, Video, VideoLike, VideoComment, Genre
